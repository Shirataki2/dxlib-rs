...
fn main() -> anyhow::Result<()> {
    unsafe {
        ...
        dx_SetWindowStyleMode(2);
        dx_SetUseBackBufferTransColorFlag(TRUE);
        ...
        let transparent_handle = dx_MakeRGB8ColorSoftImage(380, 720);
        ...
        while dx_ProcessMessage() == 0 {
            ...
            dx_GetDrawScreenSoftImage(0, 0, 380, 720, transparent_handle);

            dx_UpdateLayerdWindowForSoftImage(transparent_handle);
