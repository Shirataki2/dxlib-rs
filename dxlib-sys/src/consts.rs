...
pub const DX_PI: f64 = 3.141592653589793;
pub const DX_PI_F: f32 = 3.141592653589793;
pub const DX_TWO_PI: f64 = 6.283185307179586;
pub const DX_TWO_PI_F: f32 = 6.283185307179586;
pub const MAX_IMAGE_NUM: i32 = 262144;
...
pub const MAX_MASK_NUM: i32 = 32768;
...
pub const MAX_CONSTANT_BUFFER_NUM: i32 = 32768;
...
pub const MAX_LIVE2D_CUBISM4_MODEL_NUM: i32 = 32768;
...
pub const DEFAULT_FOV: f64 = 1.0471975511965976;
pub const DEFAULT_TAN_FOV_HALF: f64 = 0.5773502691896257;
pub const DEFAULT_NEAR: f64 = 0.0;
pub const DEFAULT_FAR: f64 = 20000.0;
pub const DX_DEFAULT_FONT_HANDLE: i32 = -2;
pub const DEFAULT_FONT_SIZE: i32 = 16;
pub const DEFAULT_FONT_THINCK: i32 = 6;
pub const DEFAULT_FONT_EDGESIZE: i32 = 1;
...
pub const DX_CHARSET_UTF8: i32 = 7;
pub const DX_CHARSET_NUM: i32 = 8;
...
pub const DX_BLENDMODE_LIVE2D_ZERO: i32 = 23;
pub const DX_BLENDMODE_LIVE2D_NORMAL: i32 = 24;
pub const DX_BLENDMODE_LIVE2D_ADD: i32 = 25;
pub const DX_BLENDMODE_LIVE2D_MULT: i32 = 26;
pub const DX_BLENDMODE_LIVE2D_MASK: i32 = 27;
pub const DX_BLENDMODE_NUM: i32 = 28;
...
pub const DX_GRAPH_FILTER_REPLACEMENT: i32 = 10;
pub const DX_GRAPH_FILTER_PREMUL_ALPHA: i32 = 11;
pub const DX_GRAPH_FILTER_INTERP_ALPHA: i32 = 12;
pub const DX_GRAPH_FILTER_YUV_TO_RGB: i32 = 13;
pub const DX_GRAPH_FILTER_Y2UV1_TO_RGB: i32 = 14;
pub const DX_GRAPH_FILTER_YUV_TO_RGB_RRA: i32 = 15;
pub const DX_GRAPH_FILTER_Y2UV1_TO_RGB_RRA: i32 = 16;
pub const DX_GRAPH_FILTER_BICUBIC_SCALE: i32 = 17;
pub const DX_GRAPH_FILTER_LANCZOS3_SCALE: i32 = 18;
pub const DX_GRAPH_FILTER_PMA_BRIGHT_CLIP: i32 = 19;
pub const DX_GRAPH_FILTER_PMA_BRIGHT_SCALE: i32 = 20;
pub const DX_GRAPH_FILTER_PMA_HSB: i32 = 21;
pub const DX_GRAPH_FILTER_PMA_INVERT: i32 = 22;
pub const DX_GRAPH_FILTER_PMA_LEVEL: i32 = 23;
pub const DX_GRAPH_FILTER_PMA_TWO_COLOR: i32 = 24;
pub const DX_GRAPH_FILTER_PMA_GRADIENT_MAP: i32 = 25;
pub const DX_GRAPH_FILTER_PMA_REPLACEMENT: i32 = 26;
pub const DX_GRAPH_FILTER_NUM: i32 = 27;
...
pub const DX_GRAPH_BLEND_PMA_NORMAL: i32 = 17;
pub const DX_GRAPH_BLEND_PMA_RGBA_SELECT_MIX: i32 = 18;
pub const DX_GRAPH_BLEND_PMA_MULTIPLE: i32 = 19;
pub const DX_GRAPH_BLEND_PMA_DIFFERENCE: i32 = 20;
pub const DX_GRAPH_BLEND_PMA_ADD: i32 = 21;
pub const DX_GRAPH_BLEND_PMA_SCREEN: i32 = 22;
pub const DX_GRAPH_BLEND_PMA_OVERLAY: i32 = 23;
pub const DX_GRAPH_BLEND_PMA_DODGE: i32 = 24;
pub const DX_GRAPH_BLEND_PMA_BURN: i32 = 25;
pub const DX_GRAPH_BLEND_PMA_DARKEN: i32 = 26;
pub const DX_GRAPH_BLEND_PMA_LIGHTEN: i32 = 27;
pub const DX_GRAPH_BLEND_PMA_SOFTLIGHT: i32 = 28;
pub const DX_GRAPH_BLEND_PMA_HARDLIGHT: i32 = 29;
pub const DX_GRAPH_BLEND_PMA_EXCLUSION: i32 = 30;
pub const DX_GRAPH_BLEND_PMA_NORMAL_ALPHACH: i32 = 31;
pub const DX_GRAPH_BLEND_PMA_ADD_ALPHACH: i32 = 32;
pub const DX_GRAPH_BLEND_PMA_MULTIPLE_A_ONLY: i32 = 33;
pub const DX_GRAPH_BLEND_NUM: i32 = 34;
...
pub const DX_RGBA_SELECT_SRC_INV_R: i32 = 8;
pub const DX_RGBA_SELECT_SRC_INV_G: i32 = 9;
pub const DX_RGBA_SELECT_SRC_INV_B: i32 = 10;
pub const DX_RGBA_SELECT_SRC_INV_A: i32 = 11;
pub const DX_RGBA_SELECT_BLEND_INV_R: i32 = 12;
pub const DX_RGBA_SELECT_BLEND_INV_G: i32 = 13;
pub const DX_RGBA_SELECT_BLEND_INV_B: i32 = 14;
pub const DX_RGBA_SELECT_BLEND_INV_A: i32 = 15;
...
pub const DX_MV1_SHAPERATE_ADD: i32 = 0;
pub const DX_MV1_SHAPERATE_OVERWRITE: i32 = 1;
pub const MV1_SAVETYPE_MESH: i32 = 1;
pub const MV1_SAVETYPE_ANIM: i32 = 2;
pub const MV1_SAVETYPE_NORMAL: i32 = 3;
...
pub const DX_PLAYTYPE_BACK: i32 = 1;
pub const DX_PLAYTYPE_LOOP: i32 = 3;
...
pub const DX_SOUNDCURRENTTIME_TYPE_LOW_LEVEL: i32 = 0;
pub const DX_SOUNDCURRENTTIME_TYPE_SOFT: i32 = 1;
pub const DX_READSOUNDFUNCTION_PCM: i32 = 1;
pub const DX_READSOUNDFUNCTION_OGG: i32 = 2;
pub const DX_READSOUNDFUNCTION_OPUS: i32 = 4;
...
pub const DX_ZCMP_DEFAULT: i32 = 4;
pub const DX_ZCMP_REVERSE: i32 = 7;
...
pub const DX_MATERIAL_TYPE_MAT_SPEC_LUMINANCE_UNORM: i32 = 3;
pub const DX_MATERIAL_TYPE_MAT_SPEC_LUMINANCE_CLIP_UNORM: i32 = 4;
pub const DX_MATERIAL_TYPE_MAT_SPEC_LUMINANCE_CMP_GREATEREQUAL: i32 = 5;
pub const DX_MATERIAL_TYPE_MAT_SPEC_POWER_UNORM: i32 = 6;
pub const DX_MATERIAL_TYPE_MAT_SPEC_POWER_CLIP_UNORM: i32 = 7;
pub const DX_MATERIAL_TYPE_MAT_SPEC_POWER_CMP_GREATEREQUAL: i32 = 8;
pub const DX_MATERIAL_TYPE_NUM: i32 = 9;
...
pub const DX_LOADMODEL_PMD_PMX_ANIMATION_FPSMODE_30: i32 = 0;
pub const DX_LOADMODEL_PMD_PMX_ANIMATION_FPSMODE_60: i32 = 1;
...
pub const DX_PRIMTYPE_MIN: i32 = 1;
pub const DX_PRIMTYPE_MAX: i32 = 6;
...
pub const DX_GRAPHICSIMAGE_FORMAT_3D_BC7_UNORM: i32 = 17;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_BC7_UNORM_SRGB: i32 = 18;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_PLATFORM0: i32 = 19;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_PLATFORM1: i32 = 20;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_PLATFORM2: i32 = 21;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_PLATFORM3: i32 = 22;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_YUV: i32 = 23;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_ABGR_I16: i32 = 24;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_ABGR_F16: i32 = 25;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_ABGR_F32: i32 = 26;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_ONE_I8: i32 = 27;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_ONE_I16: i32 = 28;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_ONE_F16: i32 = 29;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_ONE_F32: i32 = 30;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_TWO_I8: i32 = 31;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_TWO_I16: i32 = 32;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_TWO_F16: i32 = 33;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_TWO_F32: i32 = 34;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_RGB16: i32 = 35;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_RGB32: i32 = 36;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_ALPHA_RGB32: i32 = 37;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_ABGR_I16: i32 = 38;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_ABGR_F16: i32 = 39;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_ABGR_F32: i32 = 40;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_ONE_I8: i32 = 41;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_ONE_I16: i32 = 42;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_ONE_F16: i32 = 43;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_ONE_F32: i32 = 44;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_TWO_I8: i32 = 45;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_TWO_I16: i32 = 46;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_TWO_F16: i32 = 47;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_DRAWVALID_TWO_F32: i32 = 48;
pub const DX_GRAPHICSIMAGE_FORMAT_3D_NUM: i32 = 49;
pub const DX_GRAPHICSIMAGE_FORMAT_2D: i32 = 50;
pub const DX_GRAPHICSIMAGE_FORMAT_R5G6B5: i32 = 51;
pub const DX_GRAPHICSIMAGE_FORMAT_X8A8R5G6B5: i32 = 52;
pub const DX_GRAPHICSIMAGE_FORMAT_X8R8G8B8: i32 = 53;
pub const DX_GRAPHICSIMAGE_FORMAT_A8R8G8B8: i32 = 54;
pub const DX_GRAPHICSIMAGE_FORMAT_NUM: i32 = 55;
...
pub const DX_BASEIMAGE_FORMAT_BC7_UNORM: i32 = 6;
pub const DX_BASEIMAGE_FORMAT_BC7_UNORM_SRGB: i32 = 7;
pub const DX_BASEIMAGE_FORMAT_PLATFORM0: i32 = 8;
pub const DX_BASEIMAGE_FORMAT_PLATFORM1: i32 = 9;
pub const DX_BASEIMAGE_FORMAT_PLATFORM2: i32 = 10;
pub const DX_BASEIMAGE_FORMAT_PLATFORM3: i32 = 11;
pub const DX_BASEIMAGE_FORMAT_YUV: i32 = 12;
pub const DX_MOVIESURFACE_NORMAL: i32 = 0;
pub const DX_MOVIESURFACE_OVERLAY: i32 = 1;
pub const DX_MOVIESURFACE_FULLCOLOR: i32 = 2;
pub const DX_USER_SCREEN_PIXEL_FORMAT_R5G6B5: i32 = 0;
pub const DX_USER_SCREEN_PIXEL_FORMAT_R5G5B5X1: i32 = 1;
pub const DX_USER_SCREEN_PIXEL_FORMAT_X1R5G5B5: i32 = 2;
pub const DX_USER_SCREEN_PIXEL_FORMAT_X8B8G8R8: i32 = 3;
pub const DX_USER_SCREEN_PIXEL_FORMAT_X8R8G8B8: i32 = 4;
pub const DX_USER_SCREEN_PIXEL_FORMAT_NUM: i32 = 5;
...
pub const DX_CHECKINPUT_ALL: i32 = 7;
...
pub const TOUCHINPUTPOINT_MAX: usize = 16;
...
pub const PAD_INPUT_XX: i32 = 1073741824_i32.wrapping_mul(2);
...
pub const PAD_INPUT_28: i32 = 1073741824_i32.wrapping_mul(2);
...
pub const MOUSE_INPUT_LOG_DOWN: i32 = 0;
pub const MOUSE_INPUT_LOG_UP: i32 = 1;
